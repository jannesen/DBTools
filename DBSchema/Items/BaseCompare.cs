...
internal abstract class CompareItem<TItem,TName>  where TItem:SchemaItem<TItem,TName>
                                                  where TName:class
{
...
internal enum SortReason
{
    Init        = 1
}

internal abstract class CompareItemCollection<TCompare, TItem, TName> where TCompare:CompareItem<TItem, TName>, new()
